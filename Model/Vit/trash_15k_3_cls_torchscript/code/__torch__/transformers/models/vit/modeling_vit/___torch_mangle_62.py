class ViTSelfAttention(Module):
  ...
  query : __torch__.torch.nn.modules.linear.___torch_mangle_59.Linear
  key : __torch__.torch.nn.modules.linear.___torch_mangle_60.Linear
  value : __torch__.torch.nn.modules.linear.___torch_mangle_61.Linear
  def forward(self: __torch__.transformers.models.vit.modeling_vit.___torch_mangle_62.ViTSelfAttention,
