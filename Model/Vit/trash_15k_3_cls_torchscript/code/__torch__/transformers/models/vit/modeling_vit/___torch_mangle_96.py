class ViTSelfAttention(Module):
  ...
  query : __torch__.torch.nn.modules.linear.___torch_mangle_93.Linear
  key : __torch__.torch.nn.modules.linear.___torch_mangle_94.Linear
  value : __torch__.torch.nn.modules.linear.___torch_mangle_95.Linear
  def forward(self: __torch__.transformers.models.vit.modeling_vit.___torch_mangle_96.ViTSelfAttention,
