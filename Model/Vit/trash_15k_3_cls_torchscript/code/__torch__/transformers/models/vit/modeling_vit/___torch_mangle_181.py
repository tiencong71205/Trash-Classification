class ViTSelfAttention(Module):
  ...
  query : __torch__.torch.nn.modules.linear.___torch_mangle_178.Linear
  key : __torch__.torch.nn.modules.linear.___torch_mangle_179.Linear
  value : __torch__.torch.nn.modules.linear.___torch_mangle_180.Linear
  def forward(self: __torch__.transformers.models.vit.modeling_vit.___torch_mangle_181.ViTSelfAttention,
