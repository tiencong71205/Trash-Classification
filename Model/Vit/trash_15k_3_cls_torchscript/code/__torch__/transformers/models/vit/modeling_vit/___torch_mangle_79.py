class ViTSelfAttention(Module):
  ...
  query : __torch__.torch.nn.modules.linear.___torch_mangle_76.Linear
  key : __torch__.torch.nn.modules.linear.___torch_mangle_77.Linear
  value : __torch__.torch.nn.modules.linear.___torch_mangle_78.Linear
  def forward(self: __torch__.transformers.models.vit.modeling_vit.___torch_mangle_79.ViTSelfAttention,
