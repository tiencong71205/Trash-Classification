class ViTSelfAttention(Module):
  ...
  query : __torch__.torch.nn.modules.linear.___torch_mangle_110.Linear
  key : __torch__.torch.nn.modules.linear.___torch_mangle_111.Linear
  value : __torch__.torch.nn.modules.linear.___torch_mangle_112.Linear
  def forward(self: __torch__.transformers.models.vit.modeling_vit.___torch_mangle_113.ViTSelfAttention,
