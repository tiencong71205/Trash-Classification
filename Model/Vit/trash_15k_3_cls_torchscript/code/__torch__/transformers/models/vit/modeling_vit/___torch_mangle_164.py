class ViTSelfAttention(Module):
  ...
  query : __torch__.torch.nn.modules.linear.___torch_mangle_161.Linear
  key : __torch__.torch.nn.modules.linear.___torch_mangle_162.Linear
  value : __torch__.torch.nn.modules.linear.___torch_mangle_163.Linear
  def forward(self: __torch__.transformers.models.vit.modeling_vit.___torch_mangle_164.ViTSelfAttention,
