class ViTSelfAttention(Module):
  ...
  query : __torch__.torch.nn.modules.linear.___torch_mangle_25.Linear
  key : __torch__.torch.nn.modules.linear.___torch_mangle_26.Linear
  value : __torch__.torch.nn.modules.linear.___torch_mangle_27.Linear
  def forward(self: __torch__.transformers.models.vit.modeling_vit.___torch_mangle_28.ViTSelfAttention,
