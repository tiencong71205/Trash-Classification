class ViTSelfAttention(Module):
  ...
  query : __torch__.torch.nn.modules.linear.___torch_mangle_144.Linear
  key : __torch__.torch.nn.modules.linear.___torch_mangle_145.Linear
  value : __torch__.torch.nn.modules.linear.___torch_mangle_146.Linear
  def forward(self: __torch__.transformers.models.vit.modeling_vit.___torch_mangle_147.ViTSelfAttention,
