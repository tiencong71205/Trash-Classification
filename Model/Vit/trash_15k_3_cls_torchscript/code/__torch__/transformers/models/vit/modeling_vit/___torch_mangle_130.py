class ViTSelfAttention(Module):
  ...
  query : __torch__.torch.nn.modules.linear.___torch_mangle_127.Linear
  key : __torch__.torch.nn.modules.linear.___torch_mangle_128.Linear
  value : __torch__.torch.nn.modules.linear.___torch_mangle_129.Linear
  def forward(self: __torch__.transformers.models.vit.modeling_vit.___torch_mangle_130.ViTSelfAttention,
