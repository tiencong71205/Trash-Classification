class ViTSelfAttention(Module):
  ...
  query : __torch__.torch.nn.modules.linear.___torch_mangle_42.Linear
  key : __torch__.torch.nn.modules.linear.___torch_mangle_43.Linear
  value : __torch__.torch.nn.modules.linear.___torch_mangle_44.Linear
  def forward(self: __torch__.transformers.models.vit.modeling_vit.___torch_mangle_45.ViTSelfAttention,
